...
description: "In Japanese language, to rhyme is expressed as a phrase called 'In wo fumu (韻を踏む),' which literally translates to step on a rhyme. This is the main inspiration that gave shape to this work; an interactive art where visitors can easily be a rapper by simply stepping on phrases that are projection-mapped on scattered papers on the floor. 

We are hoping that this installation would be loved by literature and newbies alike, introducing them to new artworks with each step they take."
projectType: "Side"
